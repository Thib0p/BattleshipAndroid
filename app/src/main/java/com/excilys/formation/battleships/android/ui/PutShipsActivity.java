...
import static com.excilys.formation.battleships.ship.AbstractShip.Orientation.EAST;
import static com.excilys.formation.battleships.ship.AbstractShip.Orientation.NORTH;
import static com.excilys.formation.battleships.ship.AbstractShip.Orientation.SOUTH;
import static com.excilys.formation.battleships.ship.AbstractShip.Orientation.WEST;
...
public class PutShipsActivity extends AppCompatActivity implements BoardGridFragment.BoardGridFragmentListener {
    ...
    private void updateRadioButton() {
        ...
        switch (mShips[mCurrentShip].getShipOrientation()){
            case NORTH:
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            switch (checkedId) {
                case R.id.radio_east:
                    mShips[mCurrentShip].setShipOrientation(EAST);
                    break;
                case R.id.radio_north:
                    mShips[mCurrentShip].setShipOrientation(NORTH);
                    break;
                case R.id.radio_south:
                    mShips[mCurrentShip].setShipOrientation(SOUTH);
                    break;
                case R.id.radio_west:
                    mShips[mCurrentShip].setShipOrientation(WEST);
                    break;
            }
        }
    }
